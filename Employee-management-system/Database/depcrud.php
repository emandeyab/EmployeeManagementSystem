        ...
        ";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_dep.php?id=<?php echo $row['department_id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="delete_dep.php?id=<?php echo $row['department_id']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
